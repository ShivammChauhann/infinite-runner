...
Player.prototype.update = function () {
  ...
  if (this.y > InfiniteRunner.height || this.x + this.width < 0) {
    ...
    InfiniteRunner.scoreColor = "#4cffd7";
...
function PlatformManager() {
  ...
  this.colors = ["#39dcff", "#beff5c", "#ff8a3d", "#ff6466", "#5d79ff"];
